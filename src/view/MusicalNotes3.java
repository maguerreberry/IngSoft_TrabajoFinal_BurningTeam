...
public class MusicalNotes3 implements ViewInterface,ActionListener,  BeatObserver, BPMObserver {
	/** GUI frame.*/
...
//	private Color customColor = new Color(170,180,254);
	...
	public MusicalNotes3(ControllerInterface controller,MusicalNotesModelInterface model){
